...
<main>
    <section class="jumbotron text-center">
        <div class="container">
            <h1 class="jumbotron-heading">CULA AGM User Management</h1>
            <p class="lead text-muted">This section allows you to create and manage user accounts for your AGM.</p>
        </div>
    </section>
